...
// const ModalBooking = ({ isOpen, isClose, createNewUser }) => {
...
//         className="modal-booking-container fixed top-0 left-1/4 w-1/2 max-w-[1/2] flex overflow-hidden flex-col h-auto bg-white rounded-lg shadow backdrop-blur-md mx-auto mt-16"
//       >
//         {/* Header ModalBooking */}
