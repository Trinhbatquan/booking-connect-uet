  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        {isUpdate
          ? t("system.faculty.update-description")
          : t("system.faculty.create-description")}
      </div>
      <div className="">
        <div
        ...
        <div className="flex items-start gap-5 mb-4">
          <div className="flex-1 flex flex-col justify-start items-start">
            <label className="text-lg text-opacity-60 text-black flex items-center gap-1">
              {t("system.faculty.choose")} <HiOutlinePencilAlt />
            </label>
            <Select
          ...
          <div className="flex-1 flex flex-col items-start">
            ...
            >
              {t("system.faculty.overview")} <HiOutlinePencilAlt />
            </label>
            <textarea
              id="detail"
              name="detail"
        ...
        <div className="flex flex-col items-start w-full">
          <label className="text-lg text-opacity-60 text-black flex items-center gap-1">
            {t("system.faculty.detail")} <HiOutlinePencilAlt />
          </label>
          <MdEditor
            value={markdownText}
        ...
        >
          {isUpdate ? t("system.faculty.update") : t("system.faculty.add")}
        </button>
        {isUpdate && (
          <button
