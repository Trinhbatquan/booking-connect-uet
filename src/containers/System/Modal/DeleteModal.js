    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="pt-1 pb-4 px-3 flex flex-col justify-center items-center w-full">
            <span>{`Do you want to delete ${dataUserDelete?.fullName}?`}</span>
            <div className="mx-auto flex items-center justify-center gap-10 mt-4">
                <button className="outline-none py-1 px-3 w-1/2 flex items-center justify-center focus:outline-none border-none bg-red-500 text-white rounded-lg overflow-hidden shadow-sm backdrop-blur-sm"
                    onClick={() => handleDeleteUser("delete")}
                >
                    Yes
                </button>
                <button className="outline-none py-1 px-3 w-1/2 flex items-center justify-center focus:outline-none border-none bg-blue-500 text-white rounded-lg overflow-hidden shadow-sm backdrop-blur-sm"
