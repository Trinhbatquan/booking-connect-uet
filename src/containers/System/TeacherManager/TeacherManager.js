...
const TeacherManager = () => {
  ...
  const positionTemplate = (rowData) => {
    const positionId = rowData?.positionId;
    let value = "";
    if (positionId === "P1") {
      value = i18n.language === "en" ? "Profession" : "Giáo sư";
    } else if (positionId === "P2") {
      value = i18n.language === "en" ? "Associate Professor" : "Phó giáo sư";
    } else {
      value = i18n.language === "en" ? "Doctor of Philosophy" : "Tiến sĩ";
    }
  ...
  const genderTemplate = (rowData) => {
    ...
    let value = "";
    if (gender === "M") {
      value = i18n.language === "en" ? "Male" : "Nam";
    } else if (gender === "F") {
      value = i18n.language === "en" ? "Female" : "Nữ";
    } else {
      value = i18n.language === "en" ? "Others" : "Khác";
    }
    return <span>{value}</span>;
  };
        ...
        {users?.length === 0 ? null : (
          <div className="w-full mt-8">
            ...
            >
              ...
              ></Column>
              <Column
                header={t("system.table.position")}
                body={positionTemplate}
              ></Column>
              <Column
                header={t("system.teacher.teacher-faculty")}
                field="facultyData.fullName"
              ></Column>
              <Column
                header={t("system.table.gender")}
                body={genderTemplate}
              ></Column>
